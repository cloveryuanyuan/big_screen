  ...
  <main id="second">
    ...
    <section class="section" :class="{smallLeft:!bigLeft,smallRight:!bigRight}">
      ...
      <div v-if="rightInfoShow" class="right">
        <i class="icon_rf" :class="bigRight?'el-icon-s-unfold':'el-icon-s-fold'" @click="bigRight = !bigRight" />
...
export default {
  ...
  data() {
    return {
      ...
      slideData: [
        {
          ...
          src: 'http://3d.xxglpt.com/vesion3/xyl2.html',
          isMap: true
        },
        {
          id: 2,
          img: require('../../assets/image/left2.jpg'),
          src: 'https://www.renjinggai.com/console/#/login',
          isMap: false
        },
        {
          id: 3,
          img: require('../../assets/image/left3.jpg'),
          src: 'http://180.96.11.51:8080/monitor/site/login.jsp',
          isMap: true
        },
        {
          id: 4,
          img: require('../../assets/image/left4.jpg'),
          src: 'http://58.247.126.70:8385/tzpsgis/index.jsp',
          isMap: false
        },
        {
          id: 5,
          img: require('../../assets/image/left5.jpg'),
          src: 'http://180.96.11.51:9777/',
          isMap: true
        },
        {
          id: 6,
      ...
      imgs: {
        qing: require('../../assets/image/qing.png'),
        yin: require('../../assets/image/yin.png'),
        yun: require('../../assets/image/yun.png')
      }
    }
  },
  computed: {
  ...
  methods: {
    getDateWeatherAir() {
      ...
      const url = process.env.NODE_ENV === 'development' ? '/weather/api' : 'https://www.tianqiapi.com/api'
      axios.get(url, {
        params: {
          version: 'v6',
        ...
        .then(data => {
          ...
          this.currentDate.img = this.imgs[info.wea_img] ? this.imgs[info.wea_img] : this.imgs.yin
        })
    },
    runSwiper() {
    ...
    goToLink(item) {
      ...
      this.bigRight = true// 每次切换右侧初始状态都处于显示
    },
    prev() {
